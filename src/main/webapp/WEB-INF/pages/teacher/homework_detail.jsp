...
<head>
    ...
    <script src="../js/teacher/homework_detail.js"></script>
...
<div>
    <div style="margin-top: 20px;">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="date" id="date" lay-verify="datetime" placeholder="yyyy-MM-dd HH:mm:ss"
                ...
                <c:choose>
                    ...
                    <c:when test="${selectedClass != null && selectedCoz != null}">
                        ...
                        <c:forEach items='${selectedClass}' var="selectedItem" varStatus="selectedIndex">
                            <div class="layui-input-block clazz_course_select"
                                 style="margin-left: 0px; float: left; margin-top: 5px;">
                                <label class="layui-form-label">班级</label>
                                <div class="layui-input-inline" style="width: 250px;">
                                    <select class="choose_clazz" name="clazzNum" lay-filter="class_num"
                                            lay-verify="required">
                                        ...
                                        <c:forEach items='${allCourseAndClass.get("classList")}' var="clazz">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <option value="${clazz.classNum}"
                                                            selected="">${clazz.className}</option>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="layui-input-inline" style="width: 350px;">
                                    <select class="choose_course" name="courseNum" lay-filter="course_num"
                                            lay-verify="required">
                                        ...
                                        <c:forEach items='${allCourseAndClass.get("cozList")}' var="course">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <option value="${course.cozNum}"
                                                            selected="">${course.cozName}</option>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                    </select>
                                    ...
                                    <%--   -号图标    --%>
                                <button type="button" class="layui-btn layui-btn-primary layui-btn-sm del_select"
                                        style="margin-top: 4px;margin-left: 15px;">
                                    <i class="layui-icon layui-icon-delete"></i>
                                </button>
                                    <%--   +号图标    --%>
                                <button type="button" class="layui-btn layui-btn-primary layui-btn-sm add_select"
                                        style="margin-top: 4px;margin-left: 15px;">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button type="button" class="layui-btn task_submit" lay-submit="" lay-filter="submit_btn_no_files">
                        立即提交
                    </button>
