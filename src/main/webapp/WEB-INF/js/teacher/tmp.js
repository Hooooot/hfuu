// layui.use(['table','element','layer'],function(){let table=layui.table,element=layui.element,layer=layui.layer;
// table.render({elem:'#data_table1',url:'./json_test',even:true,where:{"page":"1","limit":"30"},
// request:{pageName:"page",limitName:"limit"},toolbar:'#toolbarDemo',defaultToolbar:['filter','exports','print',
...
// width:120,edit:'text'},{fixed:'right',title:'操作',toolbar:'#barDemo',width:150}]],page:true});table.on('toolbar(data_table1)',
...
// table.on('tool(data_table1)',function(obj){let data=obj.data;if(obj.event==='del'){layer.confirm('真的删除行么',function(index){obj.del();
...
// });
//
// layui.use(['table','element','layer'],function(){let table=layui.table,element=layui.element,layer=layui.layer;table.render({" +
//     "elem:'#data_table1'" +   // 修改
